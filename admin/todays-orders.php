...
$t1="23:59:59";
$to=date('Y-m-d')." ".$t1;
$query=mysqli_query($conn,"SELECT * FROM orders WHERE order_date Between '$from' and '$to'");
$cnt=1;
...
?>										
										<tr>
											...
											<td><?php echo htmlentities($row['address'].",".$row['city'].",".$row['state']."-".$row['pin_code']);?></td>
											<td><?php echo htmlentities($row['cars_name']);?></td>

											<td><?php echo htmlentities($row['cars_price']);?></td>
